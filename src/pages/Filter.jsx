...
const Filter=()=>{
  ...
  const handleSearch=async (e)=>
  {
    ...
    try {
      ...
      toast.error(err.response?.data?.message || "Failed to fetch transactions. Please try again.");
    }
    finally{
      setLoading(false);
    }
    ...
    <Dashboard activeMenu="Filters">
      <div className="my-5 mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4 mb-4">
          ...
          <form className="grid grid-cols-1 sm:grid-cols-6 md:grid cols-6 gap-4">
            <div>
