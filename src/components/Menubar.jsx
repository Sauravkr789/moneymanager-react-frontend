    ...
    >
      ...
      <div className="relative" ref={dropdownRef}>
        {/* <button 
                ...
                className="flex items-center justify-center h-10 w-10 bg-gray-100 hover:bg-gray-200 rounded-full transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-purple-800 focus:ring-offset-2">
            ...
            <div className="px-4 py-3 border-b border-gray-100">
              <div className="flex items-center gap-3">
                <div className="flex items-center justify-center w-8 h-8 bg-gray-100 rounded-full overflow-hidden">
                  {/* CHECK: Same logic for the smaller avatar in the dropdown */}
                  {user?.profileImageUrl ? (
                    <img
                      src={user.profileImageUrl}
                      alt="profile"
      ...
      {/*Mobile view */}
      {openSideMenu && (
        <div className="fixed left-0 right-0 top-[73px] bg-white border-b border-gray-200 z-20 lg:hidden">
